...
final class StatusBarController: NSObject, NSPopoverDelegate {
    ...
    private func presentCompletionNotice(_ notice: CompletionNotice) async {
        ...
        case .systemNotification:
            if await showSystemNotification(notice) {
                return
            }
    ...
    private func showSystemNotification(_ notice: CompletionNotice) async -> Bool {
        ...
        content.body = notice.notificationBodyText
